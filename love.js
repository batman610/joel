...
const animate = () => {
    ...
    if(stat){
    u.writeT("Happy birthday!!",0.5*W,0.85*H);
u.writeT("I know it's very simple, but I hope you like it!",0.5*W,0.9*H);
    u.writeT("I love you so muchhh po, Bubby!",0.5*W,0.95*H);}
